...
public class CSVStateCensus {
	...
	public CSVStateCensus(int sNo, String state, long population, double increase, long area, int density, int sexRatio,
			double literacy) {
		this.sNo = sNo;
		this.state = state;
	...
	public String toString() {
		return "S.No: " + sNo + ", State: " + state + ", Population: " + population + ", Increase(%) : " + increase
				+ ", Area(Km2): " + area + ", Density: " + density + " Sex Ratio: " + sexRatio + ", Literacy: "
				+ literacy;
	}
}
